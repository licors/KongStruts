                            ...
                            <tr align="center">
                                <td colspan="9">
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <div class="col-md-3" style="padding-right: 0px;">
                                                <select name="searchNum"  class="form-control input-sm">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3" style="padding-left: 0px;">
                                                <input class="searchk form-control input-sm" type="text" name="searchKeyword" size="15" maxlength="20" /> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-inline">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3"><input type="text" id="datepicker1" name="datepicker1" class="form-control input-sm"></div>
                                        </div>
                                        <div class="form-group">~</div>
                                        <div class="form-group">
                                            <div class="col-md-3"><input type="text" id="datepicker2" name="datepicker2" class="form-control input-sm"></div>
                                        </div>
                                    </div>
