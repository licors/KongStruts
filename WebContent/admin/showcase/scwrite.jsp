        ...
        <s:if test="rc == null">
            ...
            <s:else>
                ...
                <table align="center" width="600">
                    ...
                    <tr>
                        <td width="100" bgcolor="#F4F4F4"><font color="#FF0000">&nbsp;&nbsp;*</font>사진1</td>
                        <td width="500" bgcolor="#FFFFFF">
                    ...
                    <tr>
                        <td width="100" bgcolor="#F4F4F4"><font color="#FF0000">&nbsp;&nbsp;*</font>사진2</td>
                        <td width="500" bgcolor="#FFFFFF">
                            <s:file name="upload" theme="simple"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100" bgcolor="#F4F4F4"><font color="#FF0000">&nbsp;&nbsp;*</font>사진3</td>
                        <td width="500" bgcolor="#FFFFFF">
                            <s:file name="upload" theme="simple"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="100" bgcolor="#F4F4F4"><font color="#FF0000">&nbsp;&nbsp;*</font>사진4</td>
                        <td width="500" bgcolor="#FFFFFF">
                            <s:file name="upload" theme="simple"/>
                        </td>
                    </tr>
