        ...
        <form name="modify" method="post" action="/member/memberadminModify.action">
            ...
            <table width="500" border="1" cellspacing="0" cellpadding="1" align="center">
                ...
                <tr height="35">
                    ...
                    <td align="left"><input type="text" name="email" size="44" maxlength="50" value="<s:property value="mc.email" />"></td>
                </tr>
                <tr height="35">
                    <td width="150" align="center">이름</td>
                    <td align="left"><input type="text" name="name" size="44" maxlength="50" value="<s:property value="mc.name" />"></td>
                </tr>
                <tr height="35">
                    <td width="150" align="center">주소</td>
                    <td align="left"><input  type="text" name="zipcode" size="7" maxlength="7" value="<s:property value="mc.zipcode"/>" readonly>
                        <input type="button" value="우편번호검색" onclick="zipCheck()">
                    </td>
                </tr>
                <tr height="35">
                    <td align="center" width="150"></td>
                    <td><input type="text" name="addr1" size="44" maxlength="100" value="<s:property value="mc.addr1" />"></td>
                </tr>
                <tr height="35">
                    <td align="center" width="150"></td>
                    <td><input type="text" name="addr2" size="44" maxlength="100" value="<s:property value="mc.addr2" />"></td>
                </tr>
                <tr height="35">
