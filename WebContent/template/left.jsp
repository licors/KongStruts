...
<li><a href="/showcase/scdlist.action"><img src="/template/image/navi/all.jpg" alt="전체상품" /></a></li>
	<li><a href="/showcase/scdlist.action?showboard_category=전시"><img src="/template/image/navi/all.jpg" alt="전시" /></a></li>
	<li><a href="/showcase/scdlist.action?showboard_category=미술"><img src="/template/image/navi/all.jpg" alt="미술" /></a></li>
	<li><a href="/showcase/scdlist.action?showboard_category=이벤트"><img src="/template/image/navi/all.jpg" alt="이벤트" /></a></li>
