...
<form name="joinform" method="post" 
				action="memberM.action?member_num=<s:property value="memresultClass.member_num"/>">
				...
				<table width="500" border="1" cellspacing="0" cellpadding="1"
					...
					<tr height="35">
							...
							<td width="350" align="left"><input type="button"
									class="changepassword" value="비밀번호변경"
									onclick="return openmodifyPassword()"></td>
						</tr>
					...
					<tr height="35">
						...
						<td align="left"><input class="zipcode"
								...
								value="<s:property value="memresultClass.zipcode"/>" readonly>
									<input class="zipcodeimg" type="button" value="우편번호검색"
									onclick="zipCheck()"></td>
					...
					<tr height="35">
						...
						<td><input class="addr1" type="text" name="addr1"
								size="44" maxlength="100" value="<s:property value="memresultClass.addr1" />"></td>
					</tr>
						<tr height="35">
						<td align="center" width="150"></td>
						<td><input class="addr2" type="text" name="addr2"
								size="44" maxlength="100" value="<s:property value="memresultClass.addr2" />"></td>
					</tr>
					...
					<tr height="35">
						...
						<input class="back" type="button" value="취소" onclick="javascript:window.location.href='showcase/sclist.action'"></td>
					</tr>
				</table>
			</form>
			</center>