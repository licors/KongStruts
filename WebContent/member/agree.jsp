...
제 1 장 총 칙<br>
제 1 조 (목적)<br>
이 이용약관(이하 '약관')은 (주)캔고루(이하 ‘회사’라 합니다)와 이용 고객(이하 '회원'이라고 합니다. )간에 회사가 제공하는 캔고루(이하 ‘서비스’라 합니다.) 스마트폰 어플리케이션(이하 ‘앱’ 이라 합니다)과 웹사이트(이하 ‘웹’이라 합니다), 를 포함한 회사의 서비스(이하 ‘캔고루 서비스’라 합니다) 의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.<br>
제 2 조 (이용약관의 효력 및 변경)<br>
(1) 이 약관은 캔고루 서비스에서 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관 역시 캔고루 서비스에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.<br>
...
1. '이용고객'이라 함은 캔고루 서비스를 이용하는 이용자를 말합니다.<br>
2. ‘서비스’라 함은 캔고루 스마트폰 앱과 웹사이트의 서비스를 말합니다.<br>
3. '이용계약'이라 함은 서비스 이용과 관련하여 회사와 이용고객 간에 체결 하는 계약 말합니다.<br>
제 2 장 이용계약 체결<br>
제 5 조 (이용 계약의 성립)<br>
(1) 이용계약은 이용고객의 본 이용약관 내용에 대한 동의함으로 성립합니다.<br>
(2) 본 이용약관에 대한 동의는 이용신청 당시 해당 캔고루 서비스의 '동의함' 버튼을 누름으로써 의사표시를 합니다.<br>
제 6 조 (서비스 이용 신청)<br>
...
제 4 장 서비스의 이용<br>
제 12 조 (서비스 이용 시간)<br>
(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시중단은 캔고루 서비스의 공지사항 또는 푸시알림 및 이메일 등을 통해 사전에 공지합니다.<br>
