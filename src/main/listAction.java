...
public class listAction extends ActionSupport {
	...
	private showcasepagingAction page; // 페이징 클래스
	...
	public String execute2() throws Exception {
		...
		adpagingHtml = adpage.getAdpagingHtml().toString(); // 페이지 HTML생성.
	...
	public String adcategory() throws Exception {
		...
		adpage = new adminpagingAction(currentPage, totalCount, blockCount, blockPage,
				showboard_category, "");
		adpagingHtml = adpage.getAdpagingHtml().toString(); // 페이지HTML 생성.
